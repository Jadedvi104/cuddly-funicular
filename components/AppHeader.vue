  ...
  <header class="relative top-0 left-0 w-full z-50 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 bg-white shadow-md">
    ...
    <div class="flex flex-wrap items-center justify-between py-6">
      <div class="w-1/2 md:w-auto">
        <NuxtLink to="/" class="text-black font-bold text-2xl focus:outline-none focus:ring-2 focus:ring-blue-500">
          DentalPro
        </NuxtLink>
      </div>
        ...
        <nav
          ...
          <ul class="md:flex items-center">
            <li>
              <NuxtLink
                to="/about"
                class="py-2 inline-block md:text-black md:hidden lg:block font-semibold focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                About Us
              </NuxtLink>
            </li>
            ...
            <li class="md:ml-4">
              <NuxtLink
                to="/contact-us"
                class="py-2 inline-block md:text-black md:px-2 font-semibold focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                Contact Us
              </NuxtLink>
            </li>
            <li class="md:ml-6 mt-3 md:mt-0">
              <NuxtLink
                to="/book-appointment"
                class="inline-block font-semibold px-4 py-2 text-black bg-blue-600 md:bg-transparent md:text-black border border-white rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                Book Appointment
              </NuxtLink>
            </li>
